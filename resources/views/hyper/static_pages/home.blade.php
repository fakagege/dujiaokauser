        ...
        <div class="page-title-box">
            ...
            @if(dujiaoka_config_get('is_open_wenzhang') == \App\Models\BaseModel::STATUS_OPEN)  
               <div class="page-title">
                <a class="btn btn-outline-primary" href="/article" style="text-decoration: none;">
        ...
        <div class="hyper-wrapper">
            @foreach($data as $group)
                @foreach($group['goods'] as $goods)
                    @if($goods['in_stock'] > 0)
                    <a href="{{ url("/goods/{$goods['id']}") }}.html" class="home-card category">
                    @else
                    ...
                    @endif
                        ...
                        <div class="flex">
                         ...
                         <div class="price">
    <p>
        <b>{{ $goods['actual_price'] }}</b> {{ dujiaoka_config_get('global_currency') }}
    </p>
